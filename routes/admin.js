...
var Modelo = require('../models/modeloA');

router.get('/', function(req,res,next){//muestro a todos
...
router.get('/:id', function(req,res,next){//busco por usuario
	...
	router.post('/',function(req,res,next){//inserto datos a la tabla administradors
